...
if __name__ == '__main__':
    ...
    for i in range(1):
        host_1.udt_send('H3', 'MESSAGE_1_FROM_H1' , 0)
        host_1.udt_send('H3', 'MESSAGE_2_FROM_H1' , 0)
        host_1.udt_send('H3', 'MESSAGE_3_FROM_H1' , 0)
        host_1.udt_send('H3', 'MESSAGE_4_FROM_H1' , 0)
        host_1.udt_send('H3', 'MESSAGE_5_FROM_H1' , 1)
        host_2.udt_send('H3', 'MESSAGE_1_FROM_H2' , 1)
